...
class TrainingPipeline:
    ...
    def start_data_persistance(self, data_validation_artifact : DataValidationArtifact) -> DataPersistanceArtifact:
        try:
            ...
            data_envelop_config = DataEnvelopConfig(feature_extraction_artifact=None, data_persistance_artifact=None,data_validation_artifact=data_validation_artifact)
