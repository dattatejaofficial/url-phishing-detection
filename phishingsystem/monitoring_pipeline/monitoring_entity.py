...
class MonitoringConfig:
    def __init__(self, timestamp = datetime.now(timezone.utc)):
        ...
        self.no_of_days = monitoring_constants.NUMBER_OF_DAYS
        ...
        self.retraining_decision_report_path = os.path.join(
            self.timestamp,
            monitoring_constants.RETRAINING_DECISION_REPORT_DIR,
            monitoring_constants.RETRAINING_DECISION_REPORT_PATH
        )